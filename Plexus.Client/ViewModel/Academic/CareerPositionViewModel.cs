...
{
    public class CreateCareerPositionViewModel
    {
        ...
        public IEnumerable<CareerPositionLocalizationViewModel>? Localizations { get; set; }
    }

    public class CareerPositionViewModel : CreateCareerPositionViewModel
    {
        [JsonProperty("id")]
    ...
    public class CareerPositionLocalizationViewModel
    {
