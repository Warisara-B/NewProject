...
{
    public partial class AddStudentModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LivingStatus = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    MaritalStatus = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonalEmailAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    AdmissionType = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    AcademicStatus = table.Column<string>(type: "nvarchar(100)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_CurriculumVersions_CurriculumVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => new { x.StudentId, x.Language });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_CurriculumVersionId",
                table: "Students",
